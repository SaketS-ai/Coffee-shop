  ...
  return (
    <div className="space-y-8 pb-20 animate-fade-in text-[#241A16] w-full min-w-0">
      ...
      <section className="space-y-4 pt-2 w-full min-w-0">
        <div className="flex flex-col justify-between items-start gap-2 px-0.5">
          <div>
            <span className="text-[10px] font-mono uppercase tracking-widest text-[#6B4A3A] font-bold">
              Directory
            </span>
            <h2 className="font-editorial text-xl font-bold text-[#241A16] flex items-center space-x-2">
      ...
      {/* ========================================================================= */}
      <section className="bg-[#241A16] text-[#FBF8F2] rounded-3xl p-6 border border-[#3A2922] shadow-xl relative overflow-hidden flex flex-col gap-6 w-full">
        ...
        <div className="relative z-10 w-full flex-shrink-0">
          <button
            ...
            className="w-full py-3.5 bg-[#B98252] hover:bg-[#A85F45] text-[#FBF8F2] font-bold rounded-2xl text-xs shadow-md transition-all active:scale-[0.98] flex items-center justify-center space-x-2 cursor-pointer whitespace-nowrap"
          >
