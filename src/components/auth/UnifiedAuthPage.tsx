...
export const UnifiedAuthPage: React.FC<UnifiedAuthPageProps> = ({
  ...
  return (
    <div className="w-full min-h-screen flex flex-col md:flex-row bg-[#1E1411] text-[#F3E7D5] relative font-sans selection:bg-[#C58A55] selection:text-white">
      {/* ========================================================================= */}
      {/* DESKTOP LEFT COLUMN: Immersive Coffee Brand Showcase (58%)                 */}
      {/* ========================================================================= */}
      <div className="hidden md:flex md:w-7/12 lg:w-7/12 xl:w-7/12 min-h-screen relative overflow-hidden flex-col justify-between p-8 lg:p-14 xl:p-16 select-none border-r border-white/5">
      ...
      {/* ========================================================================= */}
      {/* RIGHT COLUMN (DESKTOP) / MAIN STACK (MOBILE): Authentication Card (42%)   */}
      {/* ========================================================================= */}
      <div className="w-full md:w-5/12 lg:w-5/12 xl:w-5/12 min-h-screen bg-[#251814] flex flex-col justify-between relative overflow-y-auto scrollbar-thin">
        
        {/* MOBILE TOP SECTION: Brand Header & Hero Visual */}
        ...
        <div className="relative z-10 w-full max-w-md mx-auto px-5 sm:px-8 py-6 md:py-10 flex-1 flex flex-col justify-center -mt-6 md:mt-0 bg-[#251814] rounded-t-[32px] md:rounded-none">
