    ...
    <div className="space-y-6 pb-16 text-[#241A16] animate-fade-in max-w-6xl mx-auto w-full">
      ...
      <section className="space-y-4">
        ...
        {isLoadingDrinks ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-3.5 w-full min-w-0">
      ...
      <section className="bg-[#FBF8F2] rounded-3xl p-5 border border-[#DDD4C8] shadow-2xs space-y-3 w-full">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-2.5 text-xs w-full">
